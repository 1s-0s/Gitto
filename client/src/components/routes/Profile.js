...
class Profile extends React.Component {
    ...
    render() {
        ...
        // }
        // else {
            const githubStat = `https://github-readme-stats.vercel.app/api?username=${this.props.userData.username}&show_icons=true&theme=blue-green&line_height=27&title_color=FFFFFF&bg_color=001E19&hide_border=true`;
            return (
                <Container>
                    <ProfileCard>
                        <Image src={this.props.userData.avatar} circular centered size="small" />
                        <ImageContent>
                        ...
                        <Section vertical>
                            <Statistic.Group widths="three">
                                <Statistic>
                                    <Statistic.Value>
                                        <StatNum>{this.props.userData.follower}</StatNum>
                                        {/* <StatNum>10</StatNum> */}
                                    </Statistic.Value>
                                    <Statistic.Label>
                                ...
                                <Statistic>
                                    <Statistic.Value>
                                        <StatNum>{this.props.userData.following}</StatNum>
                                        {/* <StatNum>20</StatNum> */}
                                    </Statistic.Value>
                                    <Statistic.Label>
                                ...
                                <Statistic>
                                    <Statistic.Value>
                                        <StatNum>{this.props.userData.repositry}</StatNum>
                                        {/* <StatNum>51</StatNum> */}
                                    </Statistic.Value>
                                    <Statistic.Label>
